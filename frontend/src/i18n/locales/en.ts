export default {
  ...
  quickMonitor: {
    title: 'Quick Ops Monitor',
    subtitle: 'Quick Ops Monitor',
    readOnly: 'Read-only View',
    suffix: 'Access suffix',
    searchByUser: 'Search username or email',
    noFilteredUsers: 'No users match the current filters',
    noFilteredSubscriptions: 'No subscriptions match the current filters',
    recordsUnit: 'records',
    reportsUnit: '{count} reports',
    ...
    ops: {
      ...
      noSystemSnapshot: 'No system resource snapshot',
      usageDetailRetention: 'Usage Detail Cleanup',
      noRetentionStatus: 'No cleanup status',
      diskMountDetails: 'Disk Mount Details',
      diskMountHint: 'Trusted mounts visible to the app process',
      noDiskMounts: 'No disk mount data',
      status: {
        noData: 'No data',
        stopped: 'Stopped',
        running: 'Cleaning',
      ...
      metrics: {
        ...
        upstreamSla: 'Upstream {upstream} · SLA {sla}',
        latencyHint: 'P95 {p95} ms · Avg {avg} ms',
        tpsPeak: 'TPS peak {value}',
        diskFree: '{mount} · {free} free',
        cleanupHint: 'Pending {pending} · Failed {failed}',
        queueDepth: 'Queue {value}',
        accountSwitch: 'Account Switches',
      },
      retention: {
        progress: 'Progress',
        pending: 'Pending',
        processed: 'Processed',
        cleaned: 'Cleaned',
        compressedRequest: 'Compressed Request',
        compressedResponse: 'Compressed Response',
        fallbackSkipped: 'Fallback / Skipped',
        failed: 'Failed',
        startedAt: 'Last Start',
        finishedAt: 'Last Finish',
        nextRun: 'Next Run',
    ...
    usageBrief: {
      groupBy: 'Group by',
      groupByPeriod: 'By date',
      groupByUser: 'By user',
      allPeriods: 'All periods',
      daily: 'Daily',
      weekly: 'Weekly',
      monthly: 'Monthly',
      noReports: 'No production reports',
      noPeriod: 'No period',
  ...
  usage: {
    ...
    compressedRequestJson: 'Compressed Request JSON',
    compressedResponseJson: 'Compressed Response JSON',
    copyJson: 'Copy JSON',
    jsonCopied: 'JSON copied',
    fullJsonCleaned: 'Full JSON has been cleaned by the retention policy. Use the compressed JSON instead.',
    detailLoadFailed: 'Failed to load request detail',
    unavailable: 'Detail unavailable',
    unavailableDisabled: 'Request detail logging is not enabled.',
    unavailableHistorical: 'This is a historical record from before request details were captured.',
    unavailableNotCaptured: 'This record has no captured request or response content to show.',
    sentMessages: 'Sent Content',
    receivedMessages: 'Returned Content',
    noMessages: 'No displayable content',
  ...
  usageBrief: {
    title: 'Usage Brief',
    description: 'View daily, weekly, and monthly reports generated from your API usage records',
    adminDescription: 'Manage usage reports, generation queues, and AI configuration for all normal users',
  },
  ...
  admin: {
    ...
    ops: {
      ...
      memory: 'Memory',
      disk: 'Disk',
      diskDetails: 'Disk Mount Details',
      mountPoint: 'Mount point',
      diskRole: 'Role',
      diskRoleDataDir: 'Data directory',
      diskRoleContainerRoot: 'Container root',
      diskRoleMount: 'Mount',
      device: 'Device',
      filesystem: 'Filesystem',
      used: 'Used',
      ...
      usageDetailRetention: 'Detail cleanup',
      retentionRunning: 'running',
      retentionWaiting: 'waiting',
      retentionIdle: 'idle',
      retentionStopped: 'stopped',
      remaining: 'remaining',
      processed: 'processed',
      cleaned: 'cleaned',
      ...
      tooltips: {
        ...
        disk: 'Disk capacity prioritized by the application data directory, with visible mount totals, used, available, and usage percentage in details.',
        ...
        usageDetailRetention: 'Background cleanup status for full usage detail JSON. It only processes yesterday from 00:00 to today 00:00 and keeps compressed JSON before clearing full request/response payloads.',
    ...
    settings: {
      ...
      features: {
        ...
        usageBrief: {
          title: 'Usage Brief',
          description: 'Show Usage Brief in the admin and user sidebars. The background worker generates daily, weekly and monthly reports for all normal users, while admins can manage queues and AI configuration.',
          configureLink: 'Configure AI generation and queues in Usage Brief',
          enabled: 'Enable Usage Brief',
          enabledHint: 'When off, sidebar entries are hidden and automatic scheduling stops. Existing reports and jobs are preserved.',
        },
        quickOpsMonitor: {
          title: 'Quick Ops Monitor',
          description: 'Expose a public read-only admin view through a configured single path segment. Use a random, sufficiently long suffix.',
          enabled: 'Enable Quick Ops Monitor',
          enabledHint: 'The shortcut is view-only and does not expose create, edit, delete, disable, cleanup or generation actions.',
          suffix: 'Access suffix',
          suffixPlaceholder: 'Example: ABCD1234',
          suffixHint: '4-64 characters; letters, numbers, hyphen and underscore only. Existing routes such as admin or api are not allowed.',
        },
        riskControl: {
          title: 'Risk Control',
