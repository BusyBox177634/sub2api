export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: 'When multiple users share the same OAuth account, convergence modes replace device/session identifiers with account-level stable values. CPA mode matches CLIProxyAPI by pseudonymizing client identifiers per account and restoring them in responses. Off = pass through client identifiers as-is.',
        codexFingerprintOff: 'Off (passthrough)',
        codexFingerprintDevice: 'Device only',
        codexFingerprintSession: 'Device + Session (recommended)',
        codexFingerprintFull: 'Full convergence',
        codexFingerprintCPA: 'CPA mode (CLIProxyAPI compatible)',
