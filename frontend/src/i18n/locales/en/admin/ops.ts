export default {
    ops: {
      ...
      tooltips: {
        ...
        usageDetailRetention:
          'Background cleanup status for full usage detail JSON. It only processes yesterday from 00:00 to today 00:00 and keeps compressed JSON before clearing full request/response payloads.',
