export default {
  ...
  chat: {
    ...
    headerEyebrow: 'Current conversation',
    apiKeyLabel: 'API Key',
    modelLabel: 'Model',
    emptyConversationsTitle: 'No conversations yet',
    emptyConversationsDesc: 'Create your first conversation to start chatting in the browser.',
    untitledConversation: 'Untitled conversation',
    emptyTitle: 'Start a new conversation',
    emptyDesc: 'Select an API Key and model to begin. This version supports image upload, paste, and drag-and-drop with per-user history isolation.',
    youLabel: 'You',
    ...
    inputPlaceholder: 'Ask a question, or paste / drag images...',
    inputPlaceholderNoImage: 'Type your question...',
    imageHint: 'Paste, drag-and-drop, and image upload are supported.',
    noImageHint: 'The current model does not support image input.',
    selectApiKeyFirst: 'Select an API Key and model first.',
    ...
    deleteConversationConfirm: 'Delete this conversation? Local attachments under it will also be removed.',
    deleteConversationFailed: 'Failed to delete conversation.',
    onlyImageSupported: 'Only image uploads are supported currently.',
