      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
        ...
        <div class="card">
          ...
          <div class="space-y-5 p-6">
            ...
            <!-- Usage Message Retention -->
            <div class="flex items-center justify-between">
              <div>
                <label class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  {{ t('admin.settings.gatewayForwarding.usageMessageRetention') }}
                </label>
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                  {{ t('admin.settings.gatewayForwarding.usageMessageRetentionHint') }}
                </p>
              </div>
              <Toggle v-model="form.usage_message_retention_enabled" />
            </div>
          </div>
        </div>
...
const form = reactive<SettingsForm>({
  ...
  usage_message_retention_enabled: false
})
...
async function saveSettings() {
  ...
  try {
    ...
    const payload: UpdateSettingsRequest = {
      ...
      usage_message_retention_enabled: form.usage_message_retention_enabled
    }
