...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	chatAttachmentStorage := service.NewChatAttachmentStorage()
	chatService := service.NewChatService(chatRepository, apiKeyService, subscriptionService, chatAttachmentStorage)
	...
	usageLogDetailRetentionService := service.ProvideUsageLogDetailRetentionService(usageLogDetailRepository, configConfig)
	...
	opsService := service.ProvideOpsService(opsRepository, settingRepository, configConfig, accountRepository, userRepository, concurrencyService, gatewayService, openAIGatewayService, geminiMessagesCompatService, antigravityGatewayService, opsSystemLogSink, usageLogDetailRetentionService, settingService, authCacheInvalidationWorker, apiKeyService)
	...
	chatHandler := handler.NewChatHandler(chatService, gatewayHandler, openAIGatewayHandler)
	usageHandler := handler.NewUsageHandler(usageService, apiKeyService, opsService, settingService)
	usageBriefRepository := repository.NewUsageBriefRepository(db)
	usageBriefService := service.ProvideUsageBriefService(usageBriefRepository, settingRepository, secretEncryptor, notificationEmailService)
	usageBriefHandler := handler.NewUsageBriefHandler(usageBriefService)
	...
	adminUsageBriefHandler := admin.NewUsageBriefHandler(usageBriefService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, adminUsageBriefHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, affiliateHandler, complianceHandler, auditLogHandler, upstreamBillingProbeService)
	...
	usageLogDetailWiring := service.ProvideUsageLogDetailWiring(gatewayService, openAIGatewayService, usageService, usageLogDetailRepository, settingService)
	idempotencyCoordinator := service.ProvideIdempotencyCoordinator(idempotencyRepository, configConfig)
	idempotencyCleanupService := service.ProvideIdempotencyCleanupService(idempotencyRepository, configConfig)
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, chatHandler, usageHandler, usageBriefHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, asyncImageHandler, batchImageHandler, usageLogDetailWiring, idempotencyCoordinator, idempotencyCleanupService)
	...
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, opsService, opsIngressRejectAggregator, apiKeyService, authCacheInvalidationWorker, schedulerSnapshotService, tokenRefreshService, accountExpiryService, proxyExpiryService, subscriptionExpiryService, usageCleanupService, usageLogDetailRetentionService, usageBriefService, idempotencyCleanupService, batchImageCleanupService, batchImageWorkerRuntime, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, openAIGatewayService, scheduledTestRunnerService, backupService, paymentOrderExpiryService, channelMonitorRunner, userPlatformQuotaUsageFlusher, upstreamBillingProbeService, auditLogService, promptService)
