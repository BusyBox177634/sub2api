...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	usageDetailRepository := repository.NewUsageLogDetailRepository(client, db)
	usageService := service.ProvideUsageService(usageLogRepository, userRepository, client, apiKeyAuthCacheInvalidator, usageDetailRepository, settingService)
