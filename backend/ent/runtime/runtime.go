...
func init() {
	...
	usagelogdetailDescRequestTruncated := usagelogdetailFields[7].Descriptor()
	...
	usagelogdetailDescResponseTruncated := usagelogdetailFields[8].Descriptor()
	...
	usagelogdetailDescUpdatedAt := usagelogdetailFields[11].Descriptor()
	...
	// userDescUsageBriefAutoEmailEnabled is the schema descriptor for usage_brief_auto_email_enabled field.
