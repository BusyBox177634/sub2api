...
var (
	...
	UsageLogDetailsColumns = []*schema.Column{
		...
		{Name: "compressed_request_payload_json", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "compressed_response_payload_json", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		...
		{Name: "full_payloads_cleaned_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "created_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		...
		ForeignKeys: []*schema.ForeignKey{
			{
				...
				Columns:    []*schema.Column{UsageLogDetailsColumns[12]},
