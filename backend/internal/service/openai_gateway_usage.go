...
func (s *OpenAIGatewayService) RecordUsage(ctx context.Context, input *OpenAIRecordUsageInput) error {
	...
	usageDetail := BuildUsageLogDetailFromCapture(input.UsageDetailCapture)
	...
	if s.cfg != nil && s.cfg.RunMode == config.RunModeSimple {
		writeUsageLogWithOptionalDetail(ctx, s.usageLogRepo, s.usageDetailRepo, usageLog, usageDetail, "service.openai_gateway")
