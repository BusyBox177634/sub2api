...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		// Usage brief feature (default disabled; opt-in)
		SettingKeyUsageBriefEnabled: "false",

		// Quick ops monitor feature (default disabled; suffix must be configured)
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	// Quick ops monitor feature (default: disabled; strict true)
	result.QuickOpsMonitorEnabled = settings[SettingKeyQuickOpsMonitorEnabled] == "true"
	result.QuickOpsMonitorSuffix = NormalizeQuickOpsMonitorSuffix(settings[SettingKeyQuickOpsMonitorSuffix])
