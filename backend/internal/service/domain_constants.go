...
const (
	...
	// SettingKeyQuickOpsMonitorEnabled exposes the read-only quick monitor under a configured suffix.
	SettingKeyQuickOpsMonitorEnabled = "quick_ops_monitor_enabled"

	// SettingKeyQuickOpsMonitorSuffix is the public single-segment suffix for quick ops monitor.
	SettingKeyQuickOpsMonitorSuffix = "quick_ops_monitor_suffix"
